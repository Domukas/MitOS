...
public class GetLine extends Process{
    ...
    {
        OS.printToConsole("GetLine blokuojasi dėl resurso [Pranešimas GetLine Procesui]");
    ...
    {
        OS.printToConsole("GetLine blokuojasi dėl resurso [Įvedimo įrenginys]");
    ...
    {
        OS.printToConsole("GetLine blokuojasi dėl resurso [Vartotojo įvesta eilutė]");
    ...
    {
        OS.printToConsole("GetLine įrašo eilute į atmintį");
    ...
    {
        OS.printToConsole("GetLine atlaisvina resursą [įvedimo įrenginys]");
    ...
    {
        OS.printToConsole("GetLine kuria resursą [įvesta eilutė supervizorinėje atmintyje]");
